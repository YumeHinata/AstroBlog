...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		credit: {
			...
			text: "居然能找到这里来嘛，这里只是用来放笔记的图书馆哦~", // Credit text to be displayed
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "随机图API",
			url: "https://rdimg.yumehinata.com/",
			external: true,
		}, {
			name: "战术棋",
			url: "/chess",
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/157667256",
		},
		{
			name: "Steam",
			icon: "fa6-brands:steam",
			url: "https://steamcommunity.com/id/Yum6/",
		},
		{
			name: "GitHub",
