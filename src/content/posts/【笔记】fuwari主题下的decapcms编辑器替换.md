...
image: https://pximg.yumehinata.com/img-master/img/2024/09/21/08/02/53/122626279_p0_master1200.jpg
tags:
  - Astro
  - Fuwari
  - blog
...
![QQ20260208-162153.png](./images/_笔记_fuwari主题下的decapcms编辑器替换/QQ20260208-162153.png)
...
```
# public\admin\vditor-plugin\index.js
(function () {
  'use strict';
  // 防止重复加载
  ...
  function testNotifications() {
    showToast('测试成功通知', 'success', 10000);
    showToast('测试错误通知', 'error', 10000);
...
```
/* public\admin\vditor-plugin\style.css */
/* Vditor 编辑器样式 */
